...
const STRINGS_EN = {
  ...
  "admin.settings.payouts.vatTitle": "VAT registration",
  "admin.settings.payouts.vatOn": "VAT registered — included on invoices",
  "admin.settings.payouts.vatOff": "Not VAT registered — invoices tax-free",
  "admin.settings.payouts.vatNoneInCountry": "no VAT",
  "admin.settings.payouts.vatHint":
    "If your business is registered with the local tax authority, leave this on so invoices include the statutory rate. Vendors under threshold or in exempt categories should turn it off.",
  "admin.settings.payouts.vatHintNoCountryVat":
    "Your country doesn't have a national VAT yet. You can keep this off; if VAT is introduced later, your invoices will pick up the new rate automatically.",
  ...
  "book.taxIncluded": "{{amount}} included",
  ...
  "invoice.tax": "Tax",
  "invoice.taxNotApplicable": "VAT (not applicable in your country)",
  "invoice.taxInclusive": "Includes VAT",
  ...
  "platform.consoleTagline": "Marketplace operations",
  "platform.consoleLabel": "Console",
  "platform.opsConsole": "Operations console",
  "platform.statusLine": "Connected · Demo dataset",
  "platform.liveLabel": "Live",
  "platform.stats.total": "Total",
  "platform.stats.gmv": "GMV (30d)",
  "platform.stats.countries": "Countries",
  "platform.col.status": "Status",
  "platform.col.business": "Business",
  "platform.col.industry": "Industry",
  "platform.col.country": "Country",
  "platform.col.actions": "Actions",
...
const STRINGS_AR: Record<TranslationKey, string> = {
  ...
  "admin.settings.payouts.vatTitle": "التسجيل في ضريبة القيمة المضافة",
  "admin.settings.payouts.vatOn": "مسجَّل في الضريبة — تظهر على الفواتير",
  "admin.settings.payouts.vatOff": "غير مسجَّل — الفواتير بدون ضريبة",
  "admin.settings.payouts.vatNoneInCountry": "بلا ضريبة",
  "admin.settings.payouts.vatHint":
    "إذا كان نشاطك مسجَّلاً لدى الهيئة الضريبية المحليّة، أبقِ هذا مفعَّلاً لتُظهر الفواتيرُ النسبةَ الرسمية. الأنشطة دون الحدّ الأدنى أو في الفئات المعفاة يجب أن توقفه.",
  "admin.settings.payouts.vatHintNoCountryVat":
    "لا توجد ضريبة قيمة مضافة وطنية في بلدك بعد. يمكنك تركه معطّلاً؛ سيتم تطبيقها تلقائياً إذا أُقرّت لاحقاً.",
  ...
  "invoice.tax": "الضريبة",
  "invoice.taxNotApplicable": "ضريبة القيمة المضافة (لا تنطبق في بلدك)",
  "invoice.taxInclusive": "شامل الضريبة",
  ...
  "platform.consoleTagline": "إدارة السوق",
  "platform.consoleLabel": "وحدة التحكّم",
  "platform.opsConsole": "وحدة عمليات المنصّة",
  "platform.statusLine": "متصل · بيانات تجريبية",
  "platform.liveLabel": "مباشر",
  "platform.stats.total": "الإجمالي",
  "platform.stats.gmv": "إيرادات (٣٠ يوم)",
  "platform.stats.countries": "البلدان",
  "platform.col.status": "الحالة",
  "platform.col.business": "النشاط",
  "platform.col.industry": "القطاع",
  "platform.col.country": "البلد",
  "platform.col.actions": "الإجراءات",
