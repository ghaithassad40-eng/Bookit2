...
export const DEMO_CONFIGS: BusinessConfigRow[] = [
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "الجمال على جدولك.",
      heroSubtitle: "قصّات وصبغات وعناية فاخرة مع نخبة الستايلست لدينا.",
      ctaText: "احجز الموعد",
      confirmationMessage: "تم الحجز. لا نطيق صبراً لرؤيتك.",
    },
    booking_rules_json: {
      allowStaffSelection: true,
      requirePhone: true,
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "رعاية دون انتظار.",
      heroSubtitle: "مواعيد خلال أيام مع أطبّاء موثوقين.",
      ctaText: "احجز زيارة",
      confirmationMessage: "تم تحديد موعد زيارتك.",
    },
    booking_rules_json: {
      allowStaffSelection: true,
      requirePhone: true,
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "اعثر على سكينتك.",
      heroSubtitle: "انضم لحصة مع مدرّبين متمرّسين.",
      ctaText: "احجز السجّادة",
      confirmationMessage: "تم حجز مكانك. تنفّس.",
    },
    booking_rules_json: {
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "اسيطر على الأرضية.",
      heroSubtitle: "ملاعب داخلية، أرضية خشبية، إضاءة على مستوى الدوريات. تأجير بالساعة وورشات.",
      ctaText: "احجز الملعب",
      confirmationMessage: "الملعب لك. اربط حذاءك.",
    },
    booking_rules_json: {
      allowStaffSelection: false,
      requirePhone: true,
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "بادل، عند الطلب.",
      heroSubtitle: "ملاعب بجدران زجاجية، إضاءة قانونية، حصص 60 دقيقة طوال اليوم.",
      ctaText: "احجز الملعب",
      confirmationMessage: "تم حجز الملعب. نلتقي على خط القاعدة.",
    },
    booking_rules_json: {
      allowStaffSelection: false,
      requirePhone: true,
  ...
  row({
    ...
    copy_json_ar: {
      heroTitle: "ضرب. رمي. كرّر.",
      heroSubtitle: "شباك داخلية، ملاعب عشبية، وحصص مدرّبة لكل المستويات.",
      ctaText: "احجز شبك",
      confirmationMessage: "تم الحجز. ارتدِ الواقيات وأحضر الماء.",
    },
    booking_rules_json: {
      allowStaffSelection: true,
      requirePhone: true,
...
export const DEMO_SERVICES: ServiceRow[] = [
  ...
  svc({
    ...
    name_ar: "ملعب خماسي (5v5)",
    description: "Full 5v5 turf pitch with floodlights, balls, bibs and goalposts. Whole pitch for one team.",
    description_ar: "ملعب 5v5 معشّب كامل مع إضاءة وكرات وقمصان وأهداف. الملعب بأكمله لفريق واحد.",
    duration_minutes: 60,
    price: 12,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    name_ar: "ملعب سباعي (7v7)",
    description: "Larger 7v7 turf with bigger goals. Ideal for full team practice or league games.",
    description_ar: "ملعب 7v7 أكبر مع أهداف أكبر. مثالي لتمارين الفريق الكاملة ومباريات الدوري.",
    duration_minutes: 60,
    price: 18,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    name_ar: "تدريب كرة قدم جماعي",
    description: "Coached 90-minute session: drills, tactics, small-sided games. Open enrolment.",
    description_ar: "حصة مدرّبة 90 دقيقة: تمارين، تكتيك، مباريات صغيرة. التسجيل مفتوح للجميع.",
    duration_minutes: 90,
    price: 6,
    currency: "KWD",
    capacity: 16,
  ...
  svc({
    ...
    name_ar: "تدريب خاص 1:1",
    description: "Tailored session with a UEFA-licensed coach. Video review available on request.",
    description_ar: "حصة مخصّصة مع مدرّب حاصل على رخصة UEFA. تحليل فيديو متاح عند الطلب.",
    duration_minutes: 60,
    price: 25,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    name_ar: "استئجار ملعب كامل",
    description: "Indoor full court, hardwood floor, scoreboard, two regulation hoops.",
    description_ar: "ملعب داخلي كامل، أرضية خشبية، لوحة نتائج، سلّتان قانونيتان.",
    duration_minutes: 60,
    price: 15,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    name_ar: "استئجار نصف ملعب",
    description: "Half court for shootarounds, 3v3, or skill work.",
    description_ar: "نصف ملعب للتمرين الفردي أو مباريات 3v3 أو العمل على المهارات.",
    duration_minutes: 60,
    price: 8,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    description_ar: "ورشة مدرّبة 90 دقيقة: تصويب، تحكّم بالكرة، دفاع.",
    duration_minutes: 90,
    price: 7,
    currency: "KWD",
    capacity: 12,
  ...
  svc({
    ...
    description_ar: "حصة خاصة مع لاعب محترف سابق. مهارات، لياقة، تحليل فيديو.",
    duration_minutes: 60,
    price: 20,
    currency: "KWD",
    capacity: 1,
  ...
  svc({
    ...
    description_ar: "ملعب بادل بجدران زجاجية، المضارب والكرات متوفّرة عند الطلب.",
    duration_minutes: 60,
    price: 160,
    currency: "SAR",
    capacity: 1,
  ...
  svc({
    ...
    description_ar: "حصة مدرّبة لأربعة لاعبين كحدّ أقصى. المبتدئون مرحّب بهم.",
    duration_minutes: 60,
    price: 90,
    currency: "SAR",
    capacity: 4,
  ...
  svc({
    ...
    description_ar: "حصة 1:1 مع مدرّب بادل معتمد. ضربات + استراتيجية مباراة.",
    duration_minutes: 60,
    price: 250,
    currency: "SAR",
    capacity: 1,
  ...
  svc({
    ...
    description_ar: "حصة شباك داخلية — آلة رمي اختيارية. أحضر مضربك أو استأجر واحداً.",
    duration_minutes: 60,
    price: 75,
    currency: "AED",
    capacity: 4,
  ...
  svc({
    ...
    business_id: "biz-boundary",
    name: "Indoor Match",
    name_ar: "مباراة داخلية",
    description: "Soft-ball indoor match. Bring 6-8 players, we provide the rest.",
    description_ar: "مباراة داخلية بكرة ليّنة. أحضر 6-8 لاعبين وسنوفّر الباقي.",
    duration_minutes: 60,
    price: 280,
    currency: "AED",
    capacity: 1,
  ...
  svc({
    ...
    description_ar: "تدريب على الضرب أو الرمي مع مدرّب معتمد من ECB.",
    duration_minutes: 60,
    price: 220,
    currency: "AED",
    capacity: 1,
